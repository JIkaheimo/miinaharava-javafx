...
public class Lauta {
     ...
     */
    void alusta(int rivienLkm, int sarakkeidenLkm, int miinojenLkm) {
     ...
     */
    Ruutu haeRuutu(int rivinIndeksi, int sarakkeenIndeksi) {
